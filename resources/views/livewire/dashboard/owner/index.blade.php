<section>
    <div class="pt-24 flex flex-col justify-center items-center">
                ...
                @foreach ($owners as $owner)
                    <tr class="w-full border-b text-xs iPhoneSE:text-base border-gray-300">
                        ...
                        <td class="px-1 sm:px-2 py-3 text-xs md:text-base font-bold break-words iPhoneSE:break-normal">
                            <span>
                                <i
                                    class="fi fi-{{ $owner->country->iso3166_1_alpha2 }} fis rounded-full scale-125"></i>
                            </span>
                            <span>{{ __($owner->country->name) }}</span>
                        </td>
                        <td class="px-1 sm:px-2 py-3 text-xs md:text-base font-bold break-words iPhoneSE:break-normal">
                            {{ $owner->business_name }}
                        </td>
                        ...
                        <td
                            ...
                            <a href="{{ route('d-owner-edit', $owner) }}">
                                <button
                            ...
                            <button wire:click="selectedOwnerToDelete({{ $owner }})"
        ...
        <br>
        {{ $owners->links() }}
        <x-modals.question-modal wire:model="confirmingDeleteOwner">
            <x-slot name="title">
                <div class="">
                    {{ __('Delete owner') }}
                </div>
            ...
            <x-slot name="content">
                {{ __('Are you sure you would like to delete this owner?') }}
            </x-slot>
