            ...
            <tr class="border-b">
                ...
                <td class="p-2">
                    <div class="text-center">
                        <button wire:click="confirmAction({{$contestant->candidate->id}})" class="m-1 p-2 bg-green-500 hover:bg-green-800 hover:cursor-pointer rounded-md shadow-md shadow-gray-300 font-bold text-white">Ganadora</button>
                    </div>
                </td>
            </tr>
        @endforeach
...
<x-modals.question-modal wire:model="confirming_winner">
    <x-slot name="title">
        <div class="">
            {{ __('Confirm winner') }}
        </div>
    ...
    <x-slot name="content">
        {{ __('Are you sure that this contestant is the winner of this edition?') }}
    </x-slot>
