...
<x-modals.question-modal wire:model="confirming_semifinalist">
    <x-slot name="title">
        <div class="">
            {{ __('Confirm semifinalist') }}
        </div>
    </x-slot>
    <x-slot name="content">
        {{ __('Are you sure that this contestant is the semifinalist of this edition?') }}
    </x-slot>
    <x-slot name="footer">
        <button class=""></button>
