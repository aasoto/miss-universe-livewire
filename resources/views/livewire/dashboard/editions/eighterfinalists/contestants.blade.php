...
<x-modals.question-modal wire:model="confirming_eighterfinalist">
    <x-slot name="title">
        <div class="">
            {{ __('Confirm eighterfinalist') }}
        </div>
    </x-slot>
    <x-slot name="content">
        {{ __('Are you sure that this contestant is the eighterfinalist of this edition?') }}
    </x-slot>
    <x-slot name="footer">
        <button class=""></button>
