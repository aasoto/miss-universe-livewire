...
<x-modals.question-modal wire:model="confirming_third_runner_up">
    <x-slot name="title">
        <div class="">
            {{ __('Confirm third runner up') }}
        </div>
    </x-slot>
    <x-slot name="content">
        {{ __('Are you sure that this contestant is the third runner up of this edition?') }}
    </x-slot>
    <x-slot name="footer">
        <button class=""></button>
