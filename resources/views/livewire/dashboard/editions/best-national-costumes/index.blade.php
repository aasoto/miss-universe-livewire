            ...
            @foreach ($best_national_costumes as $best_national_costume)
                <tr class="w-full border-b text-xs iPhoneSE:text-base border-gray-300">
                    <td class="px-1 sm:px-2 py-3 text-xs md:text-base text-center break-words iPhoneSE:break-normal">
                        {{ $best_national_costume->id }}
                    </td>
                    <td class="px-1 sm:px-2 py-3 text-xs md:text-base font-bold break-words iPhoneSE:break-normal">
                        {{ $best_national_costume->edition->year }}
                    </td>
                    <td class="px-1 sm:px-2 py-3 text-xs md:text-base break-words iPhoneSE:break-normal">
                        {{ $best_national_costume->edition->name }}
                    </td>
                    <td class="px-1 sm:px-2 py-3 text-xs md:text-base font-bold break-words iPhoneSE:break-normal">
                        {{ __($best_national_costume->candidate->country->name) }}
                    </td>
                    <td class="px-1 sm:px-2 py-3 text-xs md:text-base break-words iPhoneSE:break-normal">
                        {{ $best_national_costume->candidate->first_name.' '.$best_national_costume->candidate->second_name.' '.$best_national_costume->candidate->first_last_name.' '.$best_national_costume->candidate->second_last_name }}
                    </td>
                    <td class="flex gap-1 justify-center items-center px-1 sm:px-2 py-3 text-xs md:text-base break-words iPhoneSE:break-normal">
                        ...
                        <a href="{{ route('d-editions-best-national-costume-edit', $best_national_costume) }}">
                            <button
                        ...
                        <button wire:click="selectedBestNationalCostumeToDelete({{ $best_national_costume }})"
