...
<x-modals.question-modal wire:model="confirming_miss_photogenic">
    <x-slot name="title">
        <div class="">
            {{ __('Confirm Miss Photogenic') }}
        </div>
    </x-slot>
    <x-slot name="content">
        {{ __('Are you sure that this contestant is the miss photogenic of this edition?') }}
    </x-slot>
    <x-slot name="footer">
        <button class=""></button>
