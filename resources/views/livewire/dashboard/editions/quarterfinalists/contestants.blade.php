...
<x-modals.question-modal wire:model="confirming_quarterfinalist">
    <x-slot name="title">
        <div class="">
            {{ __('Confirm quarterfinalist') }}
        </div>
    </x-slot>
    <x-slot name="content">
        {{ __('Are you sure that this contestant is the quarterfinalist of this edition?') }}
    </x-slot>
    <x-slot name="footer">
        <button class=""></button>
