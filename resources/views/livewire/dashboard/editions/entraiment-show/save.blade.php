@slot('header')
    {{ __('Ingresar entertainment show') }}
@endslot
...
<div>
    ...
    <x-form.form-primary submit="submit" class="items-center">
        @slot('title')
            {{__('Ingresar show de entretenimiento')}}
        @endslot
        @slot('form')
            <div class="col-span-6 sm:col-span-3">
                <x-jet-label for="">Artista</x-jet-label>
                <x-jet-input-error for='artist'/>
                <x-jet-input type="text" wire:model="artist" class="w-full"/>
            </div>
            <div class="col-span-6 sm:col-span-3">
            ...
            <div class="col-span-6 sm:col-span-3">
                <x-jet-label for="">Actos</x-jet-label>
                <x-jet-input-error for='act_performing'/>
                <select class="w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
