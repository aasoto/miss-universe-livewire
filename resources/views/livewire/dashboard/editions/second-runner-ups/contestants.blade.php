...
<x-modals.question-modal wire:model="confirming_second_runner_up">
    <x-slot name="title">
        <div class="">
            {{ __('Confirm second runner up') }}
        </div>
    </x-slot>
    <x-slot name="content">
        {{ __('Are you sure that this contestant is the second runner up of this edition?') }}
    </x-slot>
    <x-slot name="footer">
        <button class=""></button>
