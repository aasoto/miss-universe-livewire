...
<x-jet-modal class="mt-24" :id="$id" :maxWidth="$maxWidth" {{ $attributes }}>
    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
        <div class="sm:flex sm:flex-col sm:items-start">
            <div class="mx-auto">
                <div class="mx-auto shrink-0 flex items-center justify-center h-32 w-32 rounded-full bg-green-100 sm:mx-0 sm:h-32 sm:w-32">
                    <i class="h-24 w-24 text-green-600 fa-solid fa-check"></i>
                </div>
            </div>
